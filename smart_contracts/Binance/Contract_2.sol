...
contract Contract_2 is Ownable {
    ...
    function TransferPool() private {
        ...
        uint256 avax = AVAX.balanceOf(address(this));
        ...
        //////////////////
        uint256 t3_90_per = (eth * 90) / 100;
        ETH.transfer(Reserve, t3_90_per);
        uint256 t3_10_per = (eth * 10) / 100;
        ETH.transfer(Fund, t3_10_per);
        //////////////////
        ...
        //////////////////
        uint256 t5_90_per = (avax * 90) / 100;
        AVAX.transfer(Reserve, t5_90_per);
        uint256 t5_10_per = (avax * 10) / 100;
        AVAX.transfer(Fund, t5_10_per);
        //////////////////
