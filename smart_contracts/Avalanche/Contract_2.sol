...
contract Contract_2 is Ownable {
    ...
    function TransferPool() private {
        ...
        uint256 weth = WETH.balanceOf(address(this));
        ...
        //////////////////
        uint256 t3_90_per = (weth * 90) / 100;
        WETH.transfer(Reserve, t3_90_per);
        uint256 t3_10_per = (weth * 10) / 100;
        WETH.transfer(Fund, t3_10_per);
        //////////////////
        uint256 t4_90_per = (wbtc * 90) / 100;
        WBTC.transfer(Reserve, t4_90_per);
        uint256 t4_10_per = (wbtc * 10) / 100;
        WBTC.transfer(Fund, t4_10_per);
        //////////////////
